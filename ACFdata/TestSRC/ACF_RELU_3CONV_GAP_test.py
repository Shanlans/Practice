...
workbook = xlsxwriter.Workbook('D:\\pythonworkspace\\TensorflowTraining\\exercises\\Shen\\Practice\\ACFdata\\ACF_TestLogs\\ACF_RELU_3CONV_GAP\\Compare.xlsx')
...
logs_validation_dir = 'D:\\pythonworkspace\\TensorflowTraining\\exercises\\Shen\\Practice\\ACFdata\\ACF_TestLogs\\ACF_RELU_3CONV_GAP\\'
...
conv1,_ = layer.conv_layer(inputs=test_batch,size_in=size_in,size_out=size_out,kernel_size=CONV1_KENEL_SIZE,name='conv1')
...
with tf.Session() as sess:
    ...
    saver.restore(sess,"D:\pythonworkspace\TensorflowTraining\exercises\Shen\Practice\ACFdata\ACF_Models\ACF_RELU_3CONV_GAP\ACF_20171115.ckpt-1199")
#    sess.run(init)
