...
workbook = xlsxwriter.Workbook('D:\\pythonworkspace\\TensorflowTraining\\exercises\\Shen\\Practice\\ACFdata\\ACF_TestLogs\\ACF_LU_2CONV_GAP\\Compare.xlsx')
...
logs_validation_dir = 'D:\\pythonworkspace\\TensorflowTraining\\exercises\\Shen\\Practice\\ACFdata\\ACF_TestLogs\\ACF_LU_2CONV_GAP\\'
...
with tf.name_scope('GAP'):
    glpooling = tf.nn.avg_pool(pool2,ksize=[1,height,height,1],strides=[1,height,height,1],padding='VALID')
...
with tf.Session() as sess:
    ...
    saver.restore(sess,"D:\pythonworkspace\TensorflowTraining\exercises\Shen\Practice\ACFdata\ACF_Models\ACF_LU_2CONV_GAP\ACF_20171115.ckpt-1199")
#    sess.run(init)
