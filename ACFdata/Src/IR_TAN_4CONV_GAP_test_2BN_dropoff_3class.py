...
workbook = xlsxwriter.Workbook('D:\\pythonworkspace\\TensorflowTraining\\exercises\\Shen\\Practice\\ACFdata\\IR_logs\\IR_TestLogs\\IR_TAN_4CONV_GAP_2BN_dropoff_3class\\Compare.xlsx')
...
with tf.Session() as sess:
    ...
    saver.restore(sess,"D:\pythonworkspace\TensorflowTraining\exercises\Shen\Practice\ACFdata\IR_Models\IR_TAN_4CONV_GAP_2BN_dropoff_3class\IR_20171206.ckpt-999")
#    sess.run(init)
