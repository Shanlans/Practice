...
### 1.Creat data ### 
#number 1 to 10 data
train_dir = 'D:\\pythonworkspace\\TensorflowTraining\\exercises\\Shen\\Practice\\ACFdata\\ACF_database\\dataset2\\cog_01\\'
validate_dir = 'D:\\pythonworkspace\\TensorflowTraining\\exercises\\Shen\\Practice\\ACFdata\\ACF_database\\dataset2\\cog_02\\'
test_dir = 'D:\\pythonworkspace\\TensorflowTraining\\exercises\\Shen\\Practice\\ACFdata\\ACF_database\\dataset2\\cog_03\\'
logs_train_dir = 'D:\\pythonworkspace\\TensorflowTraining\\exercises\\Shen\\Practice\\ACFdata\\ACF_logs\\ACF_TrainLogs\\ACF_TAN_4CONV_GAP_2BN_dropoff_Final1\\dataset2\\cog_01\\'
model_train_dir = 'D:\\pythonworkspace\\TensorflowTraining\\exercises\\Shen\\Practice\\ACFdata\\ACF_Models\\ACF_TAN_4CONV_GAP_2BN_dropoff_Final1\\dataset2\\cog_01\\'
...
conv1,w1,_,_ = layer.conv_layer(inputs=BN0,size_in=size_in,size_out=size_out,kernel_size=CONV1_KENEL_SIZE,name='conv1')
print('conv1 shape= ', conv1.get_shape())
## pool1 layer ##

Act1 = layer.tanh(conv1,name='Tanh1')
...
Act2 = layer.tanh(conv2,name='Tanh2')
...
Act3 = layer.tanh(conv3,name='Tanh3')
...
Act4 = layer.tanh(conv4,name='Tanh4')
...
confusionmatrix = tf.confusion_matrix(tf.argmax(ys,1),tf.argmax(prediction,1),4,name='Confusion_matrix')
...
#            
            ...
            if  (step + 1) == MAX_STEP:
                ...
                image_save_path = 'D:\\pythonworkspace\\TensorflowTraining\\exercises\\Shen\\Practice\\ACFdata\\Src\\ACF_TAN_4CONV_GAP_2BN_dropoff_Final1\\image\\'
                ...
                for i in range(20):
                    ...
                    tst_acc,Pre,confusion_matrix = sess.run([test_acc,prediction,confusionmatrix],feed_dict={xs:tst_imgs,ys:tst_lbls,trainphase:False}) 
...
#                print('Prediction = \n%s\n Label = %s%%' %(Pre, tst_lbls))
                    ...
                    print('The Confusion matrix is %s'%confusion_matrix)
