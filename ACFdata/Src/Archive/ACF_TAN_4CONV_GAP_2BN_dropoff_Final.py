...
### 1.Creat data ### 
#number 1 to 10 data
train_dir = 'D:\\pythonworkspace\\TensorflowTraining\\exercises\\Shen\\Practice\\ACFdata\\ACF_database\\dataset1\\ACF_train\\'
validate_dir = 'D:\\pythonworkspace\\TensorflowTraining\\exercises\\Shen\\Practice\\ACFdata\\ACF_database\\dataset1\\ACF_validate\\'
test_dir = 'D:\\pythonworkspace\\TensorflowTraining\\exercises\\Shen\\Practice\\ACFdata\\ACF_database\\dataset1\\ACF_test\\'
logs_train_dir = 'D:\\pythonworkspace\\TensorflowTraining\\exercises\\Shen\\Practice\\ACFdata\\ACF_logs\\ACF_TrainLogs\\ACF_TAN_4CONV_GAP_2BN_dropoff_Final\\dataset1\\'
model_train_dir = 'D:\\pythonworkspace\\TensorflowTraining\\exercises\\Shen\\Practice\\ACFdata\\ACF_Models\\ACF_TAN_4CONV_GAP_2BN_dropoff_Final\\dataset1\\'
...
conv1,w1,_,_ = layer.conv_layer(inputs=xs,size_in=size_in,size_out=size_out,kernel_size=CONV1_KENEL_SIZE,name='conv1')
...
Act1 = layer.tanh(BN1,'Tanh1')
#Act1 = layer.relu(BN1,'Relu1')
drop1 = layer.dropout(Act1,keep_prob=keep_prob,name='Drop1')
...
pool1,_,_ = layer.max_pool_2x2(inputs=drop1,name='maxpool1')
...
IMAGE_HEIGHT = IMAGE_HEIGHT
IMAGE_WIDTH = IMAGE_WIDTH
conv2,w2,_,_ = layer.conv_layer(inputs=pool1,size_in=size_in,size_out=size_out,kernel_size=CONV2_KENEL_SIZE,name='conv2')
...
Act2 = layer.tanh(BN2,'Tanh2')
#Act2 = layer.relu(BN2,'Relu2')
drop2 = layer.dropout(Act2,keep_prob=keep_prob,name='Drop2')
...
IMAGE_HEIGHT = IMAGE_HEIGHT/2
IMAGE_WIDTH = IMAGE_WIDTH/2
pool2,_,_ = layer.max_pool_2x2(inputs=drop2,name='maxpool2')
...
IMAGE_HEIGHT = IMAGE_HEIGHT
IMAGE_WIDTH = IMAGE_WIDTH
conv3,w3,_,_ = layer.conv_layer(inputs=pool2,size_in=size_in,size_out=size_out,kernel_size=CONV3_KENEL_SIZE,name='conv3')
print('conv3 shape= ', conv3.get_shape())


BN3 = layer.batch_norm_layer(conv3,trainphase,'BN3')
Act3 = layer.tanh(BN3,'Tanh3')
#Act3 = layer.relu(BN3,'Relu3')
drop3 = layer.dropout(Act3,keep_prob=keep_prob,name='Drop3')
...
IMAGE_HEIGHT = IMAGE_HEIGHT/2
IMAGE_WIDTH = IMAGE_WIDTH/2
pool3,_,_ = layer.max_pool_2x2(inputs=drop3,name='maxpool3')
...
IMAGE_HEIGHT = IMAGE_HEIGHT
IMAGE_WIDTH = IMAGE_WIDTH
conv4,w4,_,_ = layer.conv_layer(inputs=pool3,size_in=size_in,size_out=size_out,kernel_size=CONV4_KENEL_SIZE,name='conv4')
print('conv4 shape= ', conv4.get_shape())

BN4 = layer.batch_norm_layer(conv4,trainphase,'BN4')
Act4 = layer.tanh(BN4,'Tanh4')
#Act4 = layer.relu(BN4,'Relu4')
drop4 = layer.dropout(Act4,keep_prob=keep_prob,name='Drop4')
...
#size_in = CONV4_KENEL_NUM
#size_out= int(IMAGE_HEIGHT*IMAGE_WIDTH*size_in)
#flat = layer.flat_layer(inputs=drop4,shape=[-1,size_out],name='flat1')
...
#
#BN5 = layer.batch_norm_layer(fc1,trainphase,'BN5')
#Act5 = layer.tanh(BN5,'Tanh5')
##Act5 = layer.relu(BN5,'Relu5')
#drop5 = layer.dropout(Act5,keep_prob=keep_prob,name='Drop5')
#
#size_in = FC1_SIZE
#size_out= CLASS_NUM
#fc2 = layer.fc_layer(inputs=drop5,size_in=size_in,size_out=size_out,name='fc2')
#print('fc2 shape= ', fc2.get_shape())
...
#            
            ...
            if  (step + 1) == MAX_STEP:
                ...
                image_save_path = 'D:\\pythonworkspace\\TensorflowTraining\\exercises\\Shen\\Practice\\ACFdata\\Src\\ACF_TAN_4CONV_GAP_2BN_dropoff_Final\\image\\'
