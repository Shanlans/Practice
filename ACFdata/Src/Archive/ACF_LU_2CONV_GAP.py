...
logs_train_dir = 'D:\\pythonworkspace\\TensorflowTraining\\exercises\\Shen\\Practice\\ACFdata\\ACF_TrainLogs\\ACF_LU_2CONV_GAP\\'
model_train_dir = 'D:\\pythonworkspace\\TensorflowTraining\\exercises\\Shen\\Practice\\ACFdata\\ACF_Models\\ACF_LU_2CONV_GAP\\'
...
with tf.Session() as sess:
    ...
    c2_image =[]
    c2_image = record_image(pool2,CONV2_KENEL_NUM,1,'c2_')
    c2_save_image = []
    c2_save_image = save_image(pool2,CONV2_KENEL_NUM)
...
#            
            ...
            if  (step + 1) == MAX_STEP:
                ...
                image_save_path = 'D:\\pythonworkspace\\TensorflowTraining\\exercises\\Shen\\Practice\\ACFdata\\Src\\ACF_LU_2CONV_GAP\\image\\'
                ...
                merge_image(cv2_save_image_group,1,7,7,28,7,4,cv2_image_name)                             
