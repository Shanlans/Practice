...
logs_train_dir = 'D:\\pythonworkspace\\TensorflowTraining\\exercises\\Shen\\Practice\\ACFdata\\ACF_TrainLogs\\ACF_TAN_2BN_dropoff\\'
model_train_dir = 'D:\\pythonworkspace\\TensorflowTraining\\exercises\\Shen\\Practice\\ACFdata\\ACF_Models\\ACF_TAN_2BN_dropoff\\'
...
fc1,_ = layer.fc_layer_withtanh(inputs=flat,size_in=size_in,size_out=size_out,name='fc1')
print('fc1 shape= ', fc1.get_shape())

## Drop1 layer##
size_in = FC1_KENEL_NUM
size_out= FC1_KENEL_NUM
drop2 = layer.dropoff(inputs=fc1,keep_prob=1,name='drop2')
print('drop2 shape= ', drop2.get_shape())

## fc2 layer ##
size_in = FC1_KENEL_NUM
size_out= CLASS_NUM
fc2,w3 = layer.fc_layer_withtanh(inputs=drop2,size_in=size_in,size_out=size_out,name='fc2')
...
#            
            ...
            if  (step + 1) == MAX_STEP:
                ...
                image_save_path = 'D:\\pythonworkspace\\TensorflowTraining\\exercises\\Shen\\Practice\\ACFdata\\Src\\ACF_TAN_2BN_dropoff\\image\\'
