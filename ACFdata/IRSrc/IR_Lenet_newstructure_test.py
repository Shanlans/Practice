...
conv1 = layer.conv_layer_withoutRelu(inputs=test_batch,size_in=size_in,size_out=size_out,kernel_size=CONV1_KENEL_SIZE,name='conv1')
...
IMAGE_HEIGHT = IMAGE_HEIGHT
IMAGE_WIDTH = IMAGE_WIDTH
conv2 = layer.conv_layer_withoutRelu(inputs=test_batch,size_in=size_in,size_out=size_out,kernel_size=3,name='conv2')
...
IMAGE_HEIGHT = IMAGE_HEIGHT
IMAGE_WIDTH = IMAGE_WIDTH
conv3 = layer.conv_layer_withoutRelu(inputs=test_batch,size_in=size_in,size_out=size_out,kernel_size=1,name='conv3')
...
with tf.Session() as sess:
    ...
    saver.restore(sess,"D:\pythonworkspace\TensorflowTraining\exercises\Shen\Practice\ACFdata\IR_Models\ACF_20171101.ckpt-999")
#    sess.run(init)
