...
workbook = xlsxwriter.Workbook('D:\\pythonworkspace\\TensorflowTraining\\exercises\\Shen\\Practice\\ACFdata\\IR_TestLogs\\12345\\Compare.xlsx')
...
### 1.Creat data ### 
#number 1 to 10 data
test_dir = 'D:\\pythonworkspace\\TensorflowTraining\\exercises\\Shen\\Practice\\ACFdata\\IR_test12345\\'
logs_test_dir = 'D:\\pythonworkspace\\TensorflowTraining\\exercises\\Shen\\Practice\\ACFdata\\IR_TestLogs\\RELU\\'
model_train_dir = 'D:\\pythonworkspace\\TensorflowTraining\\exercises\\Shen\\Practice\\ACFdata\\IR_Models\\RELU\\'
...
conv1,w1 = layer.conv_layer(inputs=test_batch,size_in=size_in,size_out=size_out,kernel_size=CONV1_KENEL_SIZE,name='conv1')
...
IMAGE_HEIGHT = IMAGE_HEIGHT
IMAGE_WIDTH = IMAGE_WIDTH
conv2,_ = layer.conv_layer(inputs=pool1,size_in=size_in,size_out=size_out,kernel_size=CONV2_KENEL_SIZE,name='conv2')
...
size_in = FC1_KENEL_NUM
size_out= CLASS_NUM
fc2 = layer.fc_layer(inputs=drop1,size_in=size_in,size_out=size_out,name='fc2')
...
with tf.Session() as sess:
    ...
    saver.restore(sess,"D:\pythonworkspace\TensorflowTraining\exercises\Shen\Practice\ACFdata\IR_Models\12345\ACF_20171123.ckpt-999")
#    sess.run(init)
